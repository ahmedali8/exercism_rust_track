...
#[test]
fn test_fibonacci_of_length() {
    assert_eq!(fibonacci_of_length(0), Vec::new());
    assert_eq!(fibonacci_of_length(1), vec![1]);
    assert_eq!(fibonacci_of_length(2), vec![1,1]);
    assert_eq!(fibonacci_of_length(3), vec![1,1,2]);
}
